namespace UIWidgets
{
	...
	public class Autocomplete : MonoBehaviour, IStylable, IUpgradeable, IUpdatable, ILateUpdatable
	{
		...
		protected virtual void HideOptions()
		{
			...
			{
				Utilities.RequireComponent<HierarchyToggle>(DisplayListView).Restore();
			}
		...
		protected virtual void ShowOptions()
		{
			...
			if (CanvasTransform != null)
			{
				Utilities.RequireComponent<HierarchyToggle>(DisplayListView).SetParent(CanvasTransform);
			}
