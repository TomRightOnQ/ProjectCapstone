namespace UIWidgets
{
		...
		where TItemView : ListViewItem
	{
		...
		protected abstract class ListViewTypeBase
		{
			...
			{
				return Owner.Viewport.Size.x + Owner.GetItemSpacingX() - Owner.LayoutBridge.GetFullMarginX();
			}
			...
			{
				return Owner.Viewport.Size.y + Owner.GetItemSpacingY() - Owner.LayoutBridge.GetFullMarginY();
			}

			/// <summary>
			/// Get visible items count starting from spiceifed index.
			/// </summary>
