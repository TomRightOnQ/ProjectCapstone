...
public static class TaskData
{
    ...
    public static Dictionary<int, TaskDataStruct> data = new Dictionary<int, TaskDataStruct>
    {
        ...
        {3000, new TaskDataStruct(3000, "End Of Demo", "Here is the end of the demo version, the rest of the stories will be complete in the following months. Use Debug menu to try more levels and features.", "RoomALevel", -1, true, false)},
