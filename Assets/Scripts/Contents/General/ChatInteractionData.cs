...
public static class ChatInteractionData
{
    ...
    public static Dictionary<int, ChatInteractionDataStruct> data = new Dictionary<int, ChatInteractionDataStruct>
    {
        ...
        {13, new ChatInteractionDataStruct(13, "What we have now is a set of shooting range level, which you must collect enough information to choose the correct character to play.", false, "Guide", new int[]{-1}, -1, new int[]{21,23}, true)},
