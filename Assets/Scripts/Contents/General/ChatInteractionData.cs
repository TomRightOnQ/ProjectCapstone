...
public static class ChatInteractionData
{
    ...
    public static Dictionary<int, ChatInteractionDataStruct> data = new Dictionary<int, ChatInteractionDataStruct>
    {
        ...
        {30020, new ChatInteractionDataStruct(30020, "Hey,where are you heading for?", false, 1001, new int[]{30021,30022}, -1, new int[]{-1}, false)},
        {30021, new ChatInteractionDataStruct(30021, "...", true, 0, new int[]{-1}, 30023, new int[]{-1}, false)},
        {30022, new ChatInteractionDataStruct(30022, "I need to find a connector.", true, 0, new int[]{-1}, 30024, new int[]{-1}, false)},
        {30023, new ChatInteractionDataStruct(30023, "Never mind, just go for it.", false, 1001, new int[]{-1}, -1, new int[]{-1}, true)},
        {30024, new ChatInteractionDataStruct(30024, "I was like why the game wasn't beginning; anyway, just go for it.", false, 1001, new int[]{-1}, -1, new int[]{-1}, true)},
        {30040, new ChatInteractionDataStruct(30040, "Who are you?", false, 1008, new int[]{-1}, 30041, new int[]{-1}, false)},
        {30041, new ChatInteractionDataStruct(30041, "Oh, I'm one of the players, and a staff ask me to grab a Type-B Connector (showing the badge).", false, 0, new int[]{-1}, 30042, new int[]{-1}, false)},
        {30042, new ChatInteractionDataStruct(30042, "Ummm, is it a connector issue?", false, 1008, new int[]{-1}, 30043, new int[]{-1}, false)},
        {30043, new ChatInteractionDataStruct(30043, "IDK, the game has not started probably for this reason, though.", false, 0, new int[]{-1}, 30044, new int[]{-1}, false)},
        {30044, new ChatInteractionDataStruct(30044, "Okay... why don't they send someone professional here? Don't they have anyone can do it?", false, 1008, new int[]{-1}, 30045, new int[]{-1}, false)},
        {30045, new ChatInteractionDataStruct(30045, "I didn't see other staffs on my way here, maybe they are all up to something.", false, 0, new int[]{-1}, 30046, new int[]{-1}, false)},
        {30046, new ChatInteractionDataStruct(30046, "It's indeed a bit weird this year, I see much fewer crew members compared to the past.", false, 1008, new int[]{-1}, 30047, new int[]{-1}, false)},
        {30047, new ChatInteractionDataStruct(30047, "Anyway, I did dive into the \"River\", but I couldn't detect anyone plugged in.", false, 1008, new int[]{-1}, 30048, new int[]{2030}, false)},
        {30048, new ChatInteractionDataStruct(30048, "(\"River,\" that should be the name of the \"server\" system.)", false, 0, new int[]{-1}, 30049, new int[]{-1}, false)},
        {30049, new ChatInteractionDataStruct(30049, "Hopefully it's a simple issue; here, take this connector.", false, 1008, new int[]{-1}, 30050, new int[]{-1}, false)},
        {30050, new ChatInteractionDataStruct(30050, "Thanks.", false, 0, new int[]{-1}, -1, new int[]{3008}, true)},
