...
public static class ChatInteractionData
{
    ...
    public static Dictionary<int, ChatInteractionDataStruct> data = new Dictionary<int, ChatInteractionDataStruct>
    {
        ...
        {10068, new ChatInteractionDataStruct(10068, "...", false, 1003, new int[]{-1}, -1, new int[]{-1}, false)},
        ...
        {20008, new ChatInteractionDataStruct(20008, "Is this a dining hall?", false, 0, new int[]{-1}, 20009, new int[]{-1}, false)},
        ...
        {20020, new ChatInteractionDataStruct(20020, "Meow meow", false, 12, new int[]{-1}, -1, new int[]{-1}, true)},
        {20021, new ChatInteractionDataStruct(20021, "Awwwwwww so cute!", false, 13, new int[]{-1}, -1, new int[]{-1}, true)},
        {20022, new ChatInteractionDataStruct(20022, "Meow", false, 14, new int[]{-1}, -1, new int[]{-1}, true)},
        {20023, new ChatInteractionDataStruct(20023, "Goodbye sweetie.", false, 15, new int[]{-1}, -1, new int[]{-1}, true)},
        {20024, new ChatInteractionDataStruct(20024, "Meow!", false, 16, new int[]{-1}, -1, new int[]{-1}, true)},
        {20030, new ChatInteractionDataStruct(20030, "A collar? Is that your cat?", false, 17, new int[]{-1}, -1, new int[]{-1}, true)},
        {20031, new ChatInteractionDataStruct(20031, "No worry, you can never catch that ******** , just let it go. This collar is actually a translator.", false, 18, new int[]{-1}, -1, new int[]{-1}, true)},
        {20032, new ChatInteractionDataStruct(20032, "Wow", false, 19, new int[]{-1}, -1, new int[]{-1}, true)},
        {20033, new ChatInteractionDataStruct(20033, "****, stop fussing. Just take it and try to talk with my cat.", false, 20, new int[]{-1}, -1, new int[]{-1}, true)},
        {20034, new ChatInteractionDataStruct(20034, "Okay, now you may get out.", false, 21, new int[]{-1}, -1, new int[]{-1}, true)},
        {20040, new ChatInteractionDataStruct(20040, "Hey sweetie", false, 22, new int[]{-1}, -1, new int[]{-1}, true)},
        {20041, new ChatInteractionDataStruct(20041, "Hey, **** u. Who the **** is sweetie, I'm **** GG Bond, GG the ******* Bond.", false, 23, new int[]{-1}, -1, new int[]{-1}, true)},
        {20042, new ChatInteractionDataStruct(20042, "*I must say your owner is a bit more polite them you...", false, 24, new int[]{-1}, -1, new int[]{-1}, true)},
        {20043, new ChatInteractionDataStruct(20043, "Mind your business! These rude ******** just walk by and pet my head. My head is not a toy.", false, 25, new int[]{-1}, -1, new int[]{-1}, true)},
        {20044, new ChatInteractionDataStruct(20044, "*Pet him", false, 26, new int[]{-1}, -1, new int[]{-1}, true)},
        {20045, new ChatInteractionDataStruct(20045, "Brrrrrr, keep doing it.", false, 27, new int[]{-1}, -1, new int[]{-1}, true)},
        {20046, new ChatInteractionDataStruct(20046, "...", false, 28, new int[]{-1}, -1, new int[]{-1}, true)},
        {20047, new ChatInteractionDataStruct(20047, "... Don't show me with that face.", false, 29, new int[]{-1}, -1, new int[]{-1}, true)},
        {20048, new ChatInteractionDataStruct(20048, "I'm a honored and royal noble cat, okay?", false, 30, new int[]{-1}, -1, new int[]{-1}, true)},
        {20049, new ChatInteractionDataStruct(20049, "... Then I shall disappear, your majesty.", false, 31, new int[]{-1}, -1, new int[]{-1}, true)},
        {20050, new ChatInteractionDataStruct(20050, "Wait, you look like competiting here for the first time right? Them I'll educate you barbarian a bit.", false, 32, new int[]{-1}, -1, new int[]{-1}, true)},
        {20051, new ChatInteractionDataStruct(20051, "Just tell your team, choose the right person for each match. The information of games is not secret, and there should be a way to find.", false, 33, new int[]{-1}, -1, new int[]{-1}, true)},
        {20052, new ChatInteractionDataStruct(20052, "I also saw a lady running toward the control room all time.", false, 34, new int[]{-1}, -1, new int[]{-1}, true)},
        {20053, new ChatInteractionDataStruct(20053, "Interesting, what is she look like?", false, 35, new int[]{-1}, -1, new int[]{-1}, true)},
        {20054, new ChatInteractionDataStruct(20054, "Uh, brown hair, with a huge bowtie thing on her head.", false, 36, new int[]{-1}, -1, new int[]{-1}, true)},
        {20055, new ChatInteractionDataStruct(20055, "Thanks sweetie.", false, 37, new int[]{-1}, -1, new int[]{-1}, true)},
        {20056, new ChatInteractionDataStruct(20056, "Get the *** out of here... You will come back and see me, right?", false, 38, new int[]{-1}, -1, new int[]{-1}, true)},
        ...
        {20100, new ChatInteractionDataStruct(20100, "Hello...?", false, 66, new int[]{-1}, -1, new int[]{-1}, true)},
        {20101, new ChatInteractionDataStruct(20101, "Ah! Are you talking to me?", false, 67, new int[]{-1}, -1, new int[]{-1}, true)},
        {20102, new ChatInteractionDataStruct(20102, "Yes", false, 68, new int[]{-1}, -1, new int[]{-1}, true)},
        {20103, new ChatInteractionDataStruct(20103, "I'm...I'm the staff here", false, 69, new int[]{-1}, -1, new int[]{-1}, true)},
        {20104, new ChatInteractionDataStruct(20104, "Are you here for maintenance? Today's matches are finished.", false, 70, new int[]{-1}, -1, new int[]{-1}, true)},
        {20105, new ChatInteractionDataStruct(20105, "Just worry about the connection stability, so I'm doing a regular check.", false, 71, new int[]{-1}, -1, new int[]{-1}, true)},
        {20106, new ChatInteractionDataStruct(20106, "Don't be nervous! I'm just a player wlaking around; here's my badge. May I have your name?", false, 72, new int[]{-1}, -1, new int[]{-1}, true)},
        {20107, new ChatInteractionDataStruct(20107, "48", false, 73, new int[]{-1}, -1, new int[]{-1}, true)},
        {20108, new ChatInteractionDataStruct(20108, "Your name is... 48?", false, 74, new int[]{-1}, -1, new int[]{-1}, true)},
        {20109, new ChatInteractionDataStruct(20109, "No, that's my work number.", false, 75, new int[]{-1}, -1, new int[]{-1}, true)},
        {20110, new ChatInteractionDataStruct(20110, "Could I call your, perhaps, real name?", false, 76, new int[]{-1}, -1, new int[]{-1}, true)},
        {20111, new ChatInteractionDataStruct(20111, "Samantha.", false, 77, new int[]{-1}, -1, new int[]{-1}, true)},
        {20112, new ChatInteractionDataStruct(20112, "Oh sorry, I didn't notice you are a girl.", false, 78, new int[]{-1}, -1, new int[]{-1}, true)},
        {20113, new ChatInteractionDataStruct(20113, "That's fine, I'm already used to it.", false, 79, new int[]{-1}, -1, new int[]{-1}, true)},
        {20114, new ChatInteractionDataStruct(20114, "All the audience and players are going to enjoy their night, but sorry to hear that you still have to work", false, 80, new int[]{-1}, -1, new int[]{-1}, true)},
        {20115, new ChatInteractionDataStruct(20115, "Well, right now it's voluntary work; I just feel like the connection stability is not as stable recently.", false, 81, new int[]{-1}, -1, new int[]{-1}, true)},
        {20116, new ChatInteractionDataStruct(20116, "Connection Stability? You mean the connection between the players and the server thing?", false, 82, new int[]{-1}, -1, new int[]{-1}, true)},
        {20117, new ChatInteractionDataStruct(20117, "Yes,it drops to 80% today, you can check at the one in your team room.", false, 83, new int[]{-1}, -1, new int[]{-1}, true)},
        {20118, new ChatInteractionDataStruct(20118, "Is it something severe?", false, 84, new int[]{-1}, -1, new int[]{-1}, true)},
        {20119, new ChatInteractionDataStruct(20119, "Since we have the matches in the virtual simulation called the Gestalt System, like a world buble; it has better to be 100% stable.", false, 85, new int[]{-1}, -1, new int[]{-1}, true)},
        {20120, new ChatInteractionDataStruct(20120, "The bubble is running by the Spell of Veronique, and Dove built the hardware... you should know her, one of the big sponsors of the game.", false, 86, new int[]{-1}, -1, new int[]{-1}, true)},
        {20121, new ChatInteractionDataStruct(20121, "This system is her favorite masterpiece! She's soooo amazing!", false, 87, new int[]{-1}, -1, new int[]{-1}, true)},
        {20122, new ChatInteractionDataStruct(20122, "Wait, who is Veronique?", false, 88, new int[]{-1}, -1, new int[]{-1}, true)},
        {20123, new ChatInteractionDataStruct(20123, "I thought you know her; I mean she also came from your guild, but as one of the best Godsend, she had to run this game instead of matching.", false, 89, new int[]{-1}, -1, new int[]{-1}, true)},
        {20124, new ChatInteractionDataStruct(20124, "Her magic is called the Crystal Field, a spell casting extremely complicated computation. With the external support and energy from the Gestalt, she could resemble the reality.", false, 90, new int[]{-1}, -1, new int[]{-1}, true)},
        {20125, new ChatInteractionDataStruct(20125, "Wow, seems that you know a lot.", false, 91, new int[]{-1}, -1, new int[]{-1}, true)},
        {20126, new ChatInteractionDataStruct(20126, "They are all great people I really admire; I'm not a Godsend with all strong magic, and sometimes I'm a bit jealous. ", false, 92, new int[]{-1}, -1, new int[]{-1}, true)},
        {20127, new ChatInteractionDataStruct(20127, "So you are here for tech work?", false, 93, new int[]{-1}, -1, new int[]{-1}, true)},
        {20128, new ChatInteractionDataStruct(20128, "I'm just a normal staff doing mundane miscellaneous, and no one will remember... even notice me, but I'm already so happy to see Dove in person!", false, 94, new int[]{-1}, -1, new int[]{-1}, true)},
        {20129, new ChatInteractionDataStruct(20129, "No, everyone is important here.", false, 95, new int[]{-1}, -1, new int[]{-1}, true)},
        {20130, new ChatInteractionDataStruct(20130, "One day you can be as great as her, no worry!", false, 96, new int[]{-1}, -1, new int[]{-1}, true)},
        {20131, new ChatInteractionDataStruct(20131, "Thank you...", false, 97, new int[]{-1}, -1, new int[]{-1}, true)},
        {20132, new ChatInteractionDataStruct(20132, "Nah, I know who I am, but anyway thanks for talking with me.", false, 98, new int[]{-1}, -1, new int[]{-1}, true)},
        ...
        {20201, new ChatInteractionDataStruct(20201, "We have heard that today's match has \"spare but tough targets\" flying around", false, 1004, new int[]{-1}, 20202, new int[]{-1}, false)},
        ...
        {20356, new ChatInteractionDataStruct(20356, "For regular games, we cannot sned the same person twice, so chain reaction could be... I would say deadly", false, 1005, new int[]{-1}, 20357, new int[]{-1}, false)},
        ...
        {30000, new ChatInteractionDataStruct(30000, "Sorry to bother you, but could you do me a favor? I need to replace a connector.", false, 99, new int[]{-1}, -1, new int[]{-1}, true)},
        {30001, new ChatInteractionDataStruct(30001, "H...Hi, sorry to bother you, but other staffs are not here so could you do me a favor? My name is 048, and could you find a Type-B Connector for me? ", false, 100, new int[]{-1}, -1, new int[]{-1}, true)},
        {30002, new ChatInteractionDataStruct(30002, "No worry Samantha,what's happening?", false, 101, new int[]{-1}, -1, new int[]{-1}, true)},
        {30003, new ChatInteractionDataStruct(30003, "No worry, what's happening?", false, 102, new int[]{-1}, -1, new int[]{-1}, true)},
        {30004, new ChatInteractionDataStruct(30004, "I inspected the conenctors yesterday, but it seems that someone has replaced it, and it cannot maintain the connection stability.", false, 103, new int[]{-1}, -1, new int[]{-1}, true)},
        {30005, new ChatInteractionDataStruct(30005, "I see, where should I go?", false, 104, new int[]{-1}, -1, new int[]{-1}, true)},
        {30006, new ChatInteractionDataStruct(30006, "It's inside the stadium's entrance tunnel; here, take my badge.", false, 105, new int[]{-1}, -1, new int[]{-1}, true)},
        {30007, new ChatInteractionDataStruct(30007, "Sure, I'll give it a try.", false, 106, new int[]{-1}, -1, new int[]{-1}, true)},
        {30008, new ChatInteractionDataStruct(30008, "Thank you! This really helps! TAT", false, 107, new int[]{-1}, -1, new int[]{-1}, true)},
        ...
        {30047, new ChatInteractionDataStruct(30047, "Anyway, I did dive into the \"River\", but I couldn't detect anyone plugged in.", false, 120, new int[]{-1}, -1, new int[]{-1}, true)},
