...
public static class ReminderData
{
    ...
    public static Dictionary<int, ReminderDataStruct> data = new Dictionary<int, ReminderDataStruct>
    {
        ...
        {17, new ReminderDataStruct(17, "Auch ich habe den Wert der Zeit einst ¨¹berschatzt, darum wollte ich hundert Jahre alt werden. In der Ewigkeit aber, siehst du, gibt es keine Zeit; die Ewigkeit ist bloss ein Augenblick, gerade lange genug fur einen Spass.\n\t\t\t\t\t Hermann Hesse, Steppenwolf", 6f, "None", Enums.CHARACTER_TYPE.You)},
        ...
        {26, new ReminderDataStruct(26, "Maybe I can walk around before going back to the teamroom", 6f, "You", Enums.CHARACTER_TYPE.You)},
        ...
        {28, new ReminderDataStruct(28, "Wait, why did I mention \"third\" in my mind... did I come here for some reason?", 3f, "You", Enums.CHARACTER_TYPE.You)},
