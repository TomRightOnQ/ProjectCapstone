...
public static class HUDInteractionData
{
    ...
    public static Dictionary<int, HUDInteractionDataStruct> data = new Dictionary<int, HUDInteractionDataStruct>
    {
        ...
        {20014, new HUDInteractionDataStruct(20014, "Pet", new int[]{2018}, false, false)},
        {20015, new HUDInteractionDataStruct(20015, "Pet", new int[]{2019}, false, false)},
        {20016, new HUDInteractionDataStruct(20016, "GGBond", new int[]{2020}, false, false)},
        {20017, new HUDInteractionDataStruct(20017, "Talk", new int[]{2023}, false, false)},
        {20018, new HUDInteractionDataStruct(20018, "?", new int[]{2024}, false, false)},
